...
public class CameraSource {
    ...
    public boolean onSingleTapConfirm(Rect focusRect) {
        synchronized (mCameraLock) {
            if (mCamera != null) {
                ...
                if (parameters.getSupportedFocusModes().contains(Camera.Parameters.FOCUS_MODE_AUTO)) {
                    ...
                    // try to autoFocus..
                    try {
                        mCamera.autoFocus((b, camera) -> cleanupSingleTabFocus(camera));
                    } catch (RuntimeException e) {
                        cleanupSingleTabFocus(mCamera);
                    }
    ...
    private void cleanupSingleTabFocus(Camera camera) {
        // return to original focus mode...
        if (getFocusMode() != null) {
            Camera.Parameters parameters = camera.getParameters();
            if (parameters.getSupportedFocusModes().contains(getFocusMode())) {
